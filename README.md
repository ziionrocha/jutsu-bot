...
Projeto de automação em Python que utiliza visão computacional para reconhecer jutsus na tela e executar comandos automaticamente.
...
* PyAutoGUI / PyDirectInput (Automação)
...
* Interface gráfica com controle do bot
